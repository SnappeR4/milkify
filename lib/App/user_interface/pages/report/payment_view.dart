...
class PaymentView extends StatelessWidget {
  ...
  Future<Uint8List> _generatePdf() async {
    ...
    final int totalMembers = controller.paymentTransactions.map((t) => t.memberId).toSet().length;
    final double totalPaid = controller.paymentTransactions.fold(0.0, (sum, t) => sum + t.paidAmount);
